...
<body>
	...
	<div class="main">
		...
		<div class="mainMenu">
			...
			<div class="panR">
			<ul>
				<li <?if(basename($_SERVER['SCRIPT_FILENAME'])=="index.php"):?>class="active"<?endif;?>><a href="index.php">O nas</a></li>
				...
				<li <?if(basename($_SERVER['SCRIPT_FILENAME'])=="kalkulacja.php"):?>class="active"<?endif;?>><a href="kalkulacja.php">Kalkulacja</a></li>
				<li <?if(basename($_SERVER['SCRIPT_FILENAME'])=="przetargi.php"):?>class="active"<?endif;?>><a href="przetargi.php">Przetargi</a></li>
				<li <?if(basename($_SERVER['SCRIPT_FILENAME'])=="kontakt.php"):?>class="active"<?endif;?>><a href="kontakt.php">Kontakt</a></li>
			</ul>
			</div>
			<div class="clear"></div>
		</div>
